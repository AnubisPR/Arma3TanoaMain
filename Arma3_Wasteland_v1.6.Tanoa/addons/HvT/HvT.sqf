...
#define HVT_AMOUNT 70000  // how much a player needs to be carrying to become a HvT
#define HINT_DELAY 40  // number of seconds between each HvT reminder hint
#define MARKER_REFRESH 45  // number of seconds between each HvT marker refresh
