...
_setupObjects =
{
	...
	_missionHintText = format ["An Ancient Tanoan treasure is being scavenged containing <t color='%1'>$50,000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = "The Ancient Tanoan treasures have been captured! Beware the curse...";
};
