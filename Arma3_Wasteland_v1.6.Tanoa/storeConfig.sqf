...
[
	...
	["Type 115 Rifle", "arifle_ARX_blk_F", 2500],
	["Type 115 Rifle (Hex)", "arifle_ARX_hex_F", 2500],
	["Type 115 Rifle (G Hex)", "arifle_ARX_ghex_F", 2500],

	["AKS-74U Carbine", "arifle_AKS_F", 1500],
	["AKM Rifle", "arifle_AKM_F", 2000],
	["AK-12 Rifle", "arifle_AK12_F", 2000],
	["AK-12 GL Rifle", "arifle_AK12_GL_F", 2500],

	// Marksman Rifles
	["MXM Rifle", "arifle_MXM_F", 2500],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 2500],
	["MXM Rifle (Khaki)", "arifle_MXM_khk_F", 2500, "noDLC"],
	["Rahim DMR Rifle", "srifle_DMR_01_F", 3000],
	["Mk18 ABR Rifle", "srifle_EBR_F", 3000],

	// DLC
	["CMR-76 Rifle", "srifle_DMR_07_blk_F", 3000],
	["CMR-76 Rifle (Hex)", "srifle_DMR_07_hex_F", 3000],
	["CMR-76 Rifle (G Hex)", "srifle_DMR_07_ghex_F", 3000],
	["SPAR-17 Rifle", "arifle_SPAR_03_blk_F", 3000],
	["SPAR-17 Rifle (Khaki)", "arifle_SPAR_03_khk_F", 3500],
	["SPAR-17 Rifle (Sand)", "arifle_SPAR_03_snd_F", 3500],

	["Mk14 Rifle (Camo)", "srifle_DMR_06_camo_F", 3500],
	["Mk14 Rifle (Olive)", "srifle_DMR_06_olive_F", 3500],
	["Mk-I EMR Rifle", "srifle_DMR_03_F", 3500],
	["Mk-I EMR Rifle (Camo)", "srifle_DMR_03_multicam_F", 3500],
	["Mk-I EMR Rifle (Khaki)", "srifle_DMR_03_khaki_F", 3500],
	["Mk-I EMR Rifle (Sand)", "srifle_DMR_03_tan_F", 3500],
	["Mk-I EMR Rifle (Woodland)", "srifle_DMR_03_woodland_F", 3500],
	["MAR-10 Rifle", "srifle_DMR_02_F", 5000],
	["MAR-10 Rifle (Camo)", "srifle_DMR_02_camo_F", 5000],
	["MAR-10 Rifle (Sand)", "srifle_DMR_02_sniper_F", 5000],
	...
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_LRPS_F", 7000],
	["M320 LRR Sniper (Tropic)", "srifle_LRR_tna_LRPS_F", 7000],
	["GM6 Lynx Sniper", "srifle_GM6_LRPS_F", 8000],
	["GM6 Lynx Sniper (Camo)", "srifle_GM6_camo_LRPS_F", 8000],
	["GM6 Lynx Sniper (G Hex)", "srifle_GM6_ghex_LRPS_F", 8000],
...
[
	...
	["Mk200 LMG", "LMG_Mk200_F", 3000],
	["Zafir LMG", "LMG_Zafir_F", 4000],
...
[
	...
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 800],
	["APERS Mine", "APERSMine_Range_Mag", 800],
	["Claymore Charge", "ClaymoreDirectionalMine_Remote_Mag", 800],
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 900],
...
[
	...
	["9mm 30Rnd Mag", "30Rnd_9x21_Mag", 50],
	["9mm 30Rnd SMG Mag", "30Rnd_9x21_Mag_SMG_02", 50],
	[".45 ACP 6Rnd Cylinder", "6Rnd_45ACP_Cylinder", 50],
	[".45 ACP 9Rnd Mag", "9Rnd_45ACP_Mag", 100],
	[".45 ACP 11Rnd Mag", "11Rnd_45ACP_Mag", 100],
	[".45 ACP 30Rnd Vermin Mag", "30Rnd_45ACP_MAG_SMG_01", 100],
	[".45 ACP 30Rnd Tracer (Green) Mag", "30Rnd_45ACP_Mag_SMG_01_tracer_green", 75],
	["5.45mm 30Rnd Mag", "30Rnd_545x39_Mag_F", 120],
	["5.45mm 30Rnd Tracer (Yellow) Mag", "30Rnd_545x39_Mag_Tracer_F", 100],
	["5.45mm 30Rnd Tracer (Green) Mag", "30Rnd_545x39_Mag_Tracer_Green_F", 100],
	["5.56mm 20Rnd Underwater Mag", "20Rnd_556x45_UW_mag", 100],
	["5.56mm 30Rnd STANAG Mag", "30Rnd_556x45_Stanag", 150],
	["5.56mm 30Rnd Tracer (Green) Mag", "30Rnd_556x45_Stanag_Tracer_Green", 125],
	["5.56mm 30Rnd Tracer (Yellow) Mag", "30Rnd_556x45_Stanag_Tracer_Yellow", 125],
	["5.56mm 30Rnd Tracer (Red) Mag", "30Rnd_556x45_Stanag_Tracer_Red", 125],
	["5.56mm 150Rnd Mag", "150Rnd_556x45_Drum_Mag_F", 200],
	["5.56mm 150Rnd Tracer (Red) Mag", "150Rnd_556x45_Drum_Mag_Tracer_F", 175],
	["5.56mm 200Rnd Box", "200Rnd_556x45_Box_F", 250],
	...
	["6.5mm 200Rnd Belt Case", "200Rnd_65x39_cased_Box", 125],
	["6.5mm 200Rnd Tracer (Yellow) Belt Case", "200Rnd_65x39_cased_Box_Tracer", 100],
	//["7.62mm 10Rnd Mag", "10Rnd_762x51_Mag", 100],
	["7.62mm 10Rnd Mag", "10Rnd_762x54_Mag", 100],
	["7.62mm 20Rnd Mag", "20Rnd_762x51_Mag", 100],
	["7.62mm 30Rnd Mag", "30Rnd_762x39_Mag_F", 100],
	["7.62mm 30Rnd Tracer (Yellow) Mag", "30Rnd_762x39_Mag_Tracer_F", 75],
	["7.62mm 30Rnd Tracer (Green) Mag", "30Rnd_762x39_Mag_Tracer_Green_F", 75],
...
[
	...
	["Suppressor .45 ACP", "muzzle_snds_acp", 125, "item"],
	...
	["Suppressor 6.5mm (Khaki)", "muzzle_snds_H_khk_F", 250, "item"],
	["Suppressor 6.5mm (Sand)", "muzzle_snds_H_snd_F", 250, "item"],
	...
	["Suppressor .338 (Sand)", "muzzle_snds_338_sand", 300, "item"],
	["Suppressor 9.3mm", "muzzle_snds_93mmg", 300, "item"],
	["Suppressor 9.3mm (Tan)", "muzzle_snds_93mmg_tan", 300, "item"],
	...
	["ERCO", "optic_ERCO_blk_F", 150, "item"],
	["ERCO (Khaki)", "optic_ERCO_khk_F", 200, "item"],
	["ERCO (Sand)", "optic_ERCO_snd_F", 200, "item"],
	["ARCO", "optic_Arco", 200, "item"],
	["ARCO (Black)", "optic_Arco_blk_F", 200, "item"],
	["ARCO (G Hex)", "optic_Arco_ghex_F", 200, "item"],
	["RCO", "optic_Hamr", 200, "item"],
	["RCO (Khaki)", "optic_Hamr_khk_F", 200, "item"],
	["MOS", "optic_SOS", 200, "item"],
	["MOS (Khaki)", "optic_SOS_khk_F", 200, "item"],
	["DMS", "optic_DMS", 300, "item"],
	["DMS (G Hex)", "optic_DMS_ghex_F", 300, "item"],
	["Kahlia (Sightless)", "optic_KHS_old", 300, "item"],
	["Kahlia", "optic_KHS_blk", 300, "item"],
	["Kahlia (Hex)", "optic_KHS_hex", 300, "item"],
	["Kahlia (Tan)", "optic_KHS_tan", 300, "item"],
...
[
	...
	["Stealth Combat Helmet", "H_HelmetB_TI_tna_F", 400, "hat"],
	["Enhanced Combat Helmet", "H_HelmetSpecB", 250, "hat"],
	["Enhanced Combat Helmet (Black)", "H_HelmetSpecB_blk", 250, "hat"],
	["Enhanced Combat Helmet (Snakeskin)", "H_HelmetSpecB_snakeskin", 250, "hat"],
	["Enhanced Combat Helmet (Tropic)", "H_HelmetB_Enh_tna_F", 250, "hat", "noDLC"],
	...
	["Defender Helmet (Hex)", "H_HelmetLeaderO_ocamo", 700, "hat"],
	["Defender Helmet (Urban)", "H_HelmetLeaderO_oucamo", 700, "hat"],
	["Defender Helmet (G Hex)", "H_HelmetLeaderO_ghex_F", 700, "hat", "noDLC"],
	["Pilot Helmet (NATO)", "H_PilotHelmetFighter_B", 700, "hat"],
	["Pilot Helmet (CSAT)", "H_PilotHelmetFighter_O", 700, "hat"],
	["Pilot Helmet (AAF)", "H_PilotHelmetFighter_I", 700, "hat"],
...
[
	...
	["Light Ghillie (Jungle)", "U_B_T_Sniper_F", 2500, "uni"],
	["Light Ghillie (Jungle)", "U_O_T_Sniper_F", 2500, "uni"],
	...
	["Combat Fatigues (Tropic)", "U_B_T_Soldier_F", 500, "uni", "noDLC"],
	["Combat Fatigues (Tee)", "U_B_CombatUniform_mcam_tshirt", 500, "uni"],
	["Combat Fatigues (Gangsta)", "U_I_G_resistanceLeader_F", 500, "uni"],
	["Combat Fatigues (Rolled-up)", "U_I_CombatUniform_shortsleeve", 500, "uni"],
	...
	["Officer Fatigues", "U_I_OfficerUniform", 500, "uni"],
	["Pilot Coveralls", "U_B_PilotCoveralls", 1000, "uni"],
	["Pilot Coveralls", "U_O_PilotCoveralls", 1000, "uni"],
	["Pilot Coveralls", "U_I_pilotCoveralls", 1000, "uni"],
	["Heli Pilot Coveralls", "U_B_HeliPilotCoveralls", 1000, "uni"],
	["Heli Pilot Coveralls", "U_I_HeliPilotCoveralls", 1000, "uni"],
	["Guerilla Garment", "U_BG_Guerilla1_1", 500, "uni"],  // BLUFOR
	["Guerilla Outfit (Plain, Dark)", "U_BG_Guerilla2_1", 500, "uni"],
	["Guerilla Outfit (Pattern)", "U_BG_Guerilla2_2", 500, "uni"],
	["Guerilla Outfit (Plain, Light)", "U_BG_Guerilla2_3", 500, "uni"],
	["Guerilla Smocks", "U_BG_Guerilla3_1", 500, "uni"],
	["Guerilla Apparel", "U_BG_Guerrilla_6_1", 500, "uni"],
	["Guerilla Uniform", "U_BG_leader", 500, "uni"],
	["Guerilla Garment", "U_OG_Guerilla1_1", 500, "uni"], // OPFOR
	["Guerilla Outfit (Plain, Dark)", "U_OG_Guerilla2_1", 500, "uni"],
	["Guerilla Outfit (Pattern)", "U_OG_Guerilla2_2", 500, "uni"],
	["Guerilla Outfit (Plain, Light)", "U_OG_Guerilla2_3", 500, "uni"],
	["Guerilla Smocks", "U_OG_Guerilla3_1", 500, "uni"],
	["Guerilla Apparel", "U_OG_Guerrilla_6_1", 500, "uni"],
	["Guerilla Uniform", "U_OG_leader", 500, "uni"],
	["Guerilla Garment", "U_IG_Guerilla1_1", 500, "uni"], // Independent
	["Guerilla Outfit (Plain, Dark)", "U_IG_Guerilla2_1", 500, "uni"],
	["Guerilla Outfit (Pattern)", "U_IG_Guerilla2_2", 500, "uni"],
	["Guerilla Outfit (Plain, Light)", "U_IG_Guerilla2_3", 500, "uni"],
	["Guerilla Smocks", "U_IG_Guerilla3_1", 500, "uni"],
	["Guerilla Apparel", "U_IG_Guerrilla_6_1", 500, "uni"],
	["Guerilla Uniform", "U_IG_leader", 500, "uni"],
	/*["Worker Coveralls", "U_C_WorkerCoveralls", 25, "uni"], // can only be worn by civilian units
	["T-Shirt (Blue)", "U_C_Poor_1", 200, "uni"],
	["Polo (Red/white)", "U_C_Poloshirt_redwhite", 200, "uni"],
	["Polo (Salmon)", "U_C_Poloshirt_salmon", 200, "uni"],
	["Polo (Tri-color)", "U_C_Poloshirt_tricolour", 200, "uni"],
	["Polo (Navy)", "U_C_Poloshirt_blue", 200, "uni"],
	["Polo (Burgundy)", "U_C_Poloshirt_burgundy", 200, "uni"],
	["Polo (Blue/green)", "U_C_Poloshirt_stripped", 200, "uni"],*/
	["Polo (Competitor)", "U_Competitor", 200, "uni"],
	["Polo (Rangemaster)", "U_Rangemaster", 200, "uni"],
	/*["Racing Suit (Black)", "U_C_Driver_1_black", 200, "uni"], // can only be worn by civilian units
	["Racing Suit (Blue)", "U_C_Driver_1_blue", 200, "uni"],
	["Racing Suit (Green)", "U_C_Driver_1_green", 200, "uni"],
	["Racing Suit (Yellow)", "U_C_Driver_1_yellow", 200, "uni"],
	["Racing Suit (Orange)", "U_C_Driver_1_orange", 200, "uni"],
	["Racing Suit (Red)", "U_C_Driver_1_red", 200, "uni"],
	["Racing Suit (White)", "U_C_Driver_1_white", 200, "uni"],
	["Racing Suit (Fuel)", "U_C_Driver_1", 200, "uni"],
	["Racing Suit (Bluking)", "U_C_Driver_2", 200, "uni"],
	["Racing Suit (Redstone)", "U_C_Driver_3", 200, "uni"],
	["Racing Suit (Vrana)", "U_C_Driver_4", 200, "uni"],*/
...
[
	...
	["Carrier Lite (Green)", "V_PlateCarrier1_rgr", 200, "vest"],
	...
	["Carrier Rig (CTRG)", "V_PlateCarrierH_CTRG", 250, "vest"],
	["Carrier Rig (Tropic)", "V_PlateCarrier2_tna_F", 250, "vest", "noDLC"],
	...
	["GA Carrier Rig (Digi)", "V_PlateCarrierIA2_dgtl", 1000, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 1000, "vest"],
	["GA Carrier GL Rig (Olive)", "V_PlateCarrierIAGL_oli", 1000, "vest"],
	...
	["Raven Night Vest", "V_TacVestIR_blk", 500, "vest"],
...
[
	...
	["Viper Harness (G Hex)", "B_ViperHarness_ghex_F", 450, "backpack", "noDLC"],
	...
	["Bergen (Hex)", "B_Bergen_hex_F", 2000, "backpack", "noDLC"],
...
[
	...
	["Remote Designator (NATO)", "B_Static_Designator_01_weapon_F", 1000, "backpack"],
	["Remote Designator (CSAT)", "O_Static_Designator_02_weapon_F", 1000, "backpack"],
	["GPS", "ItemGPS", 100, "gps"],
	...
	["Compact NVG (Hex)", "O_NVGoggles_hex_F", 700, "nvg"],
	["Compact NVG (G Hex)", "O_NVGoggles_ghex_F", 700, "nvg"],
	["Compact NVG (Urban)", "O_NVGoggles_urb_F", 700, "nvg"],
	["Binoculars", "Binocular", 100, "binoc"],
	["Rangefinder", "Rangefinder", 500, "binoc"],
	["Laser Designator (Sand)", "Laserdesignator", 1500, "binoc", "noDLC"], // Increase price to 2500 if A3W_disableBuiltInThermal = 0
	["Laser Designator (Hex)", "Laserdesignator_02", 1500, "binoc", "noDLC"],
	["Laser Designator (Olive)", "Laserdesignator_03", 1500, "binoc", "noDLC"],
...
[
	...
	["Quadbike (NATO)", "B_Quadbike_01_F", 500, "vehicle"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 500, "vehicle"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 500, "vehicle"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 500, "vehicle"],

	["Hatchback", "C_Hatchback_01_F", 500, "vehicle"],
	...
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 5000, "vehicle"],

	["HEMTT Tractor", "B_Truck_01_mover_F", 2000, "vehicle"],
	["HEMTT Box", "B_Truck_01_box_F", 2000, "vehicle"],
	["HEMTT Transport", "B_Truck_01_transport_F", 2000, "vehicle"],
	["HEMTT Covered", "B_Truck_01_covered_F", 2000, "vehicle"],
	...
	["Tempest Transport", "O_Truck_03_transport_F", 2000, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 2000, "vehicle"],
...
[
	["Prowler (Doorless)", "B_CTRG_LSV_01_light_F", 2000, "vehicle"],
	["Prowler", "B_T_LSV_01_unarmed_F", 3000, "vehicle"],
	["Prowler HMG", "B_T_LSV_01_armed_F", 5000, "vehicle"],
...
[
	...
	["MH-9 Hummingbird", "B_Heli_Light_01_F", 2000, "vehicle"], // MH-6
	["PO-30 Orca (Black)", "O_Heli_Light_02_unarmed_F", 3000, "vehicle"], // Ka-60
	["WY-55 Hellcat (Green)", "I_Heli_light_03_unarmed_F", 4000, "vehicle"], // AW159

	["Mi-290 Taru (Crane)", "O_Heli_Transport_04_F", 3500, "vehicle"], // CH-54
	["Mi-290 Taru (Box)", "O_Heli_Transport_04_box_F", 3000, "vehicle"],
	["Mi-290 Taru (Fuel)", "O_Heli_Transport_04_fuel_F", 5000, "vehicle"],
	["Mi-290 Taru (Bench)", "O_Heli_Transport_04_bench_F", 3000, "vehicle"],
	["Mi-290 Taru (Transport)", "O_Heli_Transport_04_covered_F", 4500, "vehicle"],
	["CH-67 Huron (Black)", "B_Heli_Transport_03_unarmed_F", 6000, "vehicle"], // CH-47
	...
	["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 20000, "vehicle"], // Armed Ka-60 with orca paintjob
	["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 25000, "vehicle"], // Armed Ka-60
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 25000, "vehicle"], // Armed AW159
	...
	["MQ-12 Falcon UAV", "B_T_UAV_03_F", 30000, "vehicle"]
];
...
[
	...
	["Y-32 Xi'an", "O_T_VTOL_02_infantry_F", 75000, "vehicle"],
...
[
	...
	["Assault Boat (NATO)", "B_Boat_Transport_01_F", 1000, "boat"],
	["Assault Boat (CSAT)", "O_Boat_Transport_01_F", 1000, "boat"],
	["Assault Boat (AAF)", "I_Boat_Transport_01_F", 1000, "boat"],
	["Assault Boat (FIA)", "B_G_Boat_Transport_01_F", 1000, "boat"],
...
[
	...
	["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 4000, 2000],
	["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 6000, 3000],
	["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 8000, 4000],
